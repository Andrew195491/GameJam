...
func create_ingredient_buttons_with_images():
    ...
    for ingredient in randomised_cat1:
        ...
        container1.add_theme_constant_override("margin_top", 5)
        container1.add_theme_constant_override("margin_bottom", 5)
    ...
    for ingredient in randomised_cat2:
        ...
        container2.add_theme_constant_override("margin_top", 5)
        container2.add_theme_constant_override("margin_bottom", 5)
    ...
    for ingredient in randomised_cat3:
        ...
        container3.add_theme_constant_override("margin_top", 5)
        container3.add_theme_constant_override("margin_bottom", 5)
    ...
    for ingredient in randomised_cat4:
        ...
        container4.add_theme_constant_override("margin_top", 5)
        container4.add_theme_constant_override("margin_bottom", 5)
...
func select_random_drink():
    ...
    chosen_ingredients.text = "Ingredients: "
    ...
    print(selected_drink_ingredients)
    ...
    $LeftPanel/Ingredient1.scale = Vector2(0.6, 0.6)
    $LeftPanel/Ingredient2.scale = Vector2(0.6, 0.6)
    $LeftPanel/Ingredient3.scale = Vector2(0.6, 0.6)
    $LeftPanel/Ingredient4.scale = Vector2(0.6, 0.6)

    print("Randomly selected drink: " + selected_drink["name"])
...
func _on_ingredient_button_pressed(ingredient):
    ...
    if ingredient in selected_ingredients:
        print("Duplicate ingredient selection: " + ingredient)
        _handle_incorrect_selection(ingredient)
        return

    if ingredient in selected_drink_ingredients:
        print("Correct ingredient: " + ingredient)
        _handle_correct_selection(ingredient)
    else:
        print("Incorrect ingredient: " + ingredient)
        _handle_incorrect_selection(ingredient)
...
func _handle_correct_selection(ingredient):
    ...
    print("Ingredient added to drink: " + ingredient)
    ...
    print(selected_drink_ingredients.find(ingredient))
...
func _handle_incorrect_selection(ingredient):
    ...
    print("Try again! Incorrect ingredient: " + ingredient)
    selected_ingredients.clear()
    chosen_ingredients.text = "Ingredients: "
...
func _process(delta):
    ...
    if mouse_is_on_screen:
        ...
        time_left -= delta * 1.2  # Speed up timer when mouse is not on screen
...
func complete_drink(flag):
    if flag:
        print("Drink creation process complete")
    else:
        print("Drink creation failed")
    # You can disable buttons here or show a "Next Round" button
    reset_game_state()
...
func reset_game_state():
    ...
    chosen_ingredients.text = "Ingredients: " + ", ".join(selected_drink["ingredients"])
